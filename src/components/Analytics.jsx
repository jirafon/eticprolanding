    ...
    <div className='w-full bg-white py-16 px-4'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
        ...
        <div className='flex flex-col justify-center'>
          ...
          como gestión de reuniones PEP, sistema de denuncias anónimas, campañas eficientes de conflictos de interés y evaluaciones claras con certificación auditada. Accede a declaraciones históricas, 
          crea formularios personalizados y otorga privilegios de co-administrador para una supervisión efectiva. Asegura una cultura de integridad y transparencia con EticPro. 
