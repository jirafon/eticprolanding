  ...
  return (
    <div className='w-full' style={{ backgroundColor: 'rgb(255, 255, 255)' }}>
      <div className='py-16 px-4'>
        ...
        <div className='max-w-[1040px] mx-auto grid md:grid-cols-1 lg:grid-cols-3 gap-8 items-center'>
          <div className='p-6 border border-gray-300 rounded-md flex flex-col justify-start items-start relative' style={{ backgroundColor: 'rgb(236, 253, 255)', height: '300px' }}>
